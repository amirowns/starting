...
class Player(Entity):
    def __init__(self):
        ...
        self.attack = 1
        self.defense = 0
        self.image = pygame.image.load("starting/python/pygamestuff/pictures/Player.png")
        self.image.convert()
...
class Goblin(Entity):
    def __init__(self):
        ...
        self.attack = 1
        self.defense = 0 
        self.image = pygame.image.load("starting/python/pygamestuff/pictures/goblin.png")
        self.image.convert()
        self.rect = self.image.get_rect()
